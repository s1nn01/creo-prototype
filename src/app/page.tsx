...
function TalentTeaser({ navigate }: { navigate: (p: string) => void }) {
  return (
    <section className="rounded-2xl bg-gradient-to-r from-pink-600 via-indigo-600 to-amber-500 text-white p-8 flex flex-col md:flex-row items-center justify-between mb-12">
